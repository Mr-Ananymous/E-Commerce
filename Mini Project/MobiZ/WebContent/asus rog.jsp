...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/Asus rog/asus rog.jpg" height="400px" width="450px">
            </div>
            <div class="carousel-item">
                <img src="images/Asus rog/asus rog front.jpg" width="370px" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/Asus rog/asus rog back1.jpeg" width="400px" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","asus rog phone");
               at.setAttribute("price","40999");
               at.setAttribute("cmp","asus");
               at.setAttribute("image","images/Asus rog/asus rog.jpg");
               at.setAttribute("link","asus rog.jsp");%>
        <h3>ASUS ROG PHONE </h3>
        <p>by <a href="https://www.asus.com/in/">ASUS</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:40999 </p> 
