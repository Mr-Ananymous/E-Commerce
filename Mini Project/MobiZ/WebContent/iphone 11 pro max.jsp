...
<meta charset="utf-8">
    ...
    <title>MobiZ-iphone 11 pro max</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/iphone/iphone 11 pro max.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/iphone/iphone 11 pro max-1.jpg"  height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/iphone/iphone 11 pro max-2.jpg" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Iphone pro max");
               at.setAttribute("price","119000");
               at.setAttribute("cmp","Apple");
               at.setAttribute("image","images/iphone/iphone 11 pro max.jpg");
               at.setAttribute("link","iphone 11 pro max.jsp");%>
        <h3>Iphone 11 PRO MAX </h3>
        <p>by <a href="https://www.apple.com/in/">APPLE</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:119000 </p> 
        ...
        <p class="pane"> Color: &nbsp;&nbsp; matt gery</p>
        <p class="pane"> RAM:  &nbsp;&nbsp;  4GB</p>
        <p class="pane"> Internal Memory:  &nbsp;&nbsp; 256GB</p>
        <p class="pane"> Camera: &nbsp;triple 12MP Cameras</p>
        <p class="pane">CPU: &nbsp;&nbsp; Hexa-core (2x2.65 GHz Lightning + 4x1.8 GHz Thunder)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Apple GPU (4-core graphics)</p>
        <p class="pane">OS: &nbsp;&nbsp;iOS 13, upgradable to iOS 13.4</p>
    ...
    <div class="card-deck">
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price : 48100 <br> Available in 3 variants </p>
        ...
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price :101400 <br> Available in 2 variants <br> <em>Free-delivery</em> </p>
