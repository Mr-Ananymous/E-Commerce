...
<meta charset="utf-8">
    ...
    <title>MobiZ-iphone 11 pro</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/iphone/iphone 11 pro.jpg" height="400px" >
            </div>
            <div class="carousel-item">
                <img src="images/iphone/iphone 11 pro-1.jpg"  height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/iphone/iphone 11 pro-2.jpg"  height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","IPHONE 11 PRO");
               at.setAttribute("price","101400");
               at.setAttribute("cmp","Apple");
               at.setAttribute("image","images/iphone/iphone 11 pro.jpg");
               at.setAttribute("link","iphone 11 pro.jsp");%>
        <h3>Iphone 11 PRO </h3>
        <p>by <a href="https://www.apple.com/in/">APPLE</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:101400 </p> 
