...
<meta charset="utf-8">
    ...
    <title>MobiZ-iphone 7 plus</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/iphone/iphone 7 plus.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/iphone/iphone 7 plus-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/iphone/iphone 7 plus-2.jpg" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","IPHONE 7 PLUS");
               at.setAttribute("price","34900");
               at.setAttribute("cmp","Apple");
               at.setAttribute("image","images/iphone/iphone 7 plus.jpg");
               at.setAttribute("link","iphone 7 plus .jsp");%>
        <h3>IPHONE XR </h3>
        <p>by <a href="https://www.apple.com/in/">APPLE</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:34900 </p> 
        ...
        <p class="pane"> Camera: &nbsp;Dual 12MP Rear Camera,7MP Front camera</p>
        <p class="pane">CPU: &nbsp;&nbsp; Quad-core 2.34 GHz (2x Hurricane + 2x Zephyr)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;PowerVR Series7XT Plus (six-core graphics)</p>
        <p class="pane">OS: &nbsp;&nbsp;iOS 10.0.1, upgradable to iOS 13.4</p>
    ...
    <div class="card-deck">
        ...
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price :48100 <br><br> Available in 3 variants <br> <em>Free-delivery</em> </p>
