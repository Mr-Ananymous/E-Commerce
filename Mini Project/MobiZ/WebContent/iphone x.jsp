...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/iphone/iphone x.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/iphone/iphone x-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/iphone/iphone x-2.jpg"  height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","IPHONE X");
               at.setAttribute("price","39999");
               at.setAttribute("cmp","Apple");
               at.setAttribute("image","images/iphone/iphone x.jpg");
               at.setAttribute("link","iphone x.jsp");%>
        <h3>Iphone X </h3>
        <p>by <a href="https://www.apple.com/in/">APPLE</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:39999 </p> 
        ...
        <p class="pane"> Camera: &nbsp; 12MP Dual Rear Camera+7MP Front camera</p>
        <p class="pane">CPU: &nbsp;&nbsp; Hexa-core 2.39 GHz (2x Monsoon + 4x Mistral)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Apple GPU (three-core graphics)</p>
        <p class="pane">OS: &nbsp;&nbsp;iOS 11.1.1, upgradable to iOS 13.4</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>12MP dual cameras with dual OIS and 7MP TrueDepth front camera—Portrait mode and Portrait Lighting</li>
...
<div class="container">
    ...
    <div class="card-deck">
        ...
        <div class="card bg-light">
            <img class="card-img-top" src="images/iphone/iphone xr.jpg">
            <div class="card-body text-center">
                <h4 class="card-title"> iphone xr</h4>
                <p class="card-text"> Price : 48100 <br><br> Available in 2 variants<br> <em>Free-delivery</em>  </p>
                <a href="iphone xr.jsp" class="btn btn-primary">Buy now </a>
            </div>
        </div>
        <div class="card bg-light">
