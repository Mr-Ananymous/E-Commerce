...
<meta charset="utf-8">
    ...
    <title>MobiZ-samsung galaxy M21</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/samsung/samsung galaxy m21.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/samsung/samsung galaxy m21-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/samsung/samsung galaxy m21-2.jpg"  height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","SAMSUNG GALAXY M21");
               at.setAttribute("price","12999");
               at.setAttribute("cmp","samsung");
               at.setAttribute("image","images/samsung/samsung galaxy m21.jpg");
               at.setAttribute("link"," m21.jsp");%>
        <h3>Samsung Galaxy M21 </h3>
        <p>by <a href="https://www.samsung.com/in/">SAMSUNG</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:12999 </p> 
        ...
        <p class="pane"> Color: &nbsp;&nbsp; Turqoise blue </p>
        <p class="pane"> RAM:  &nbsp;&nbsp;  4GB</p>
        <p class="pane"> Internal Memory:  &nbsp;&nbsp; 64GB</p>
        <p class="pane"> Camera: &nbsp; 48MP+8MP+5MP Rear Camera+20MP Front camera</p>
    ...
    <div class="card-deck">
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price : 34999<br> Available in 3 variants </p>
