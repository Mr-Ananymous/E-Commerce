...
<meta charset="utf-8">
    ...
    <title>MobiZ-samsung galaxy m30s</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/samsung/samsung m30s.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/samsung/samsung m30s-1.jpg"  height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/samsung/samsung m30s-2.jpg" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","SAMSUNG GALAXY M30S");
               at.setAttribute("price","13999");
               at.setAttribute("cmp","samsung");
               at.setAttribute("image","images/samsung/samsung galaxy m30s.jpg");
               at.setAttribute("link"," m30s.jsp");%>
        <h3>Samsung Galaxy M30S</h3>
        <p>by <a href="https://www.samsung.com/in/">SAMSUNG</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:13999 </p> 
        ...
        <p class="pane"> Camera: &nbsp; 48MP + 8MP + 5MP triple rear camera | 16MP front facing camera</p>
        <p class="pane">CPU: &nbsp;&nbsp; Octa-core (4x2.3 GHz Cortex-A73 & 4x1.7 GHz Cortex-A53)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Mali-G72 MP3</p>
        <p class="pane">OS: &nbsp;&nbsp;Android 9.0 (Pie); One UI</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>16.21 centimeters (6.4-inch) FHD+ capacitive touchscreen with 2340 x 1080 pixels resolution 16M color support</li>
        <li>Memory, Storage & SIM: 4GB RAM | 64GB storage expandable up to 512GB | Dual nano SIM with dual standby (4G+4G)</li>
...
<div class="container">
    ...
    <div class="card-deck">
        ...
        <div class="card bg-light">
            <img class="card-img-top" src="images/samsung/samsung galaxy s20.jpg">
            <div class="card-body text-center">
                <h4 class="card-title">samsung galaxy s20 </h4>
                <p class="card-text"> Price :66599 <br><br> Available in 3 variants <br> <em>Free-delivery</em> </p>
                <a href="s20.jsp" class="btn btn-primary">Buy now </a>
            </div>
        </div>
        <div class="card bg-light">
        ...
        <img class="card-img-top" src="images/samsung/samsung galaxy note 9.jpg">
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price :34999 <br> Available in 2 variants <br> <em>Free-delivery</em> </p>
