...
<meta charset="ISO-8859-1">
 ...
 <div class="container-fluid bg-info text-white product">
       <div id="ad"class="carousel slide car" data-ride="carousel">
        ...
        <img src="images/acc/mem card.jpg" width="300px" height="350px">
        </div>
        <div class="carousel-item">
        <img src="images/acc/mem card1.jpg"width="300px" height="350px">
        </div>
        </div>
        </div>
        ...
        <span class="carousel-control-next-icon"></span>
               ...
               at.setAttribute("name","memory card");
               at.setAttribute("price","700");
               at.setAttribute("cmp","acc");
               at.setAttribute("image","images/acc/mem card.jpg");
               at.setAttribute("link","memory card.jsp");%>
        <div class="container bg-light text-dark spec">
          <h3>Sandisk memory card </h3>
          <p >by <a href="https://shop.westerndigital.com/sandisk">Sandisk</a>  &nbsp;&nbsp;&nbsp;&nbsp; Price:700 </p> 
        ...
        <div class="container bg-light text-dark spec">
          ...
          <p class="pane"> Model: &nbsp;&nbsp;  SanDisk Ultra 128 GB MicroSDXC Class 10</p>
          <p class="pane"> Series:  &nbsp;&nbsp;  Extreme pro</p>
          <p class="pane"> Memory:  &nbsp;&nbsp; 128 GB</p>
          <p class="pane"> Warranty: &nbsp;&nbsp; 5 years </p>
         <p class="pane">Color: &nbsp;&nbsp; Red,Grey</p>
          <!--<p class="pane">Connectivity:  &nbsp;&nbsp;  Bluetooth</p>-->
          <p class="pane">Weight: &nbsp;&nbsp; 4.54gm</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
  ...
  <ul>
    <li>Temperature Proof, X-ray Proof, Water Proof, Shock Proof</li>
    <li> SanDisk Memory Zone: Backup, Transfer, Manage, Application</li>
    <li>Performance: Class 1 (A1), C10 for Full HD Video, UHS Speed Class 1
    </li>
  <!--<li>Microphone,call,track and volume control</li>
   <li>4500mAH lithium-polymer battery providing talk-time of 41 hours and standby time of 666 hours | 18W fast charger </li>-->
  </ul>
</div>
