...
<meta charset="utf-8">
    ...
    <title>MobiZ-samsung galaxy note 10 lite</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/samsung/samsung galaxy note 10 lite.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/samsung/samsung galaxy note 10 lite-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/samsung/samsung galaxy note 10 lite-2.jpg" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","SAMSUNG GALAXY NOTE 10 LITE");
               at.setAttribute("price","38999");
               at.setAttribute("cmp","samsung");
               at.setAttribute("image","images/samsung/samsung galaxy note 10 lite.jpg");
               at.setAttribute("link","note10.jsp");%>
        <h3>Samsung note 10 LITE </h3>
        <p>by <a href="https://www.samsung.com/in/">SAMSUNG</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:38999 </p> 
        ...
        <p class="pane"> Color: &nbsp;&nbsp;Pink shade </p>
        ...
        <p class="pane">CPU: &nbsp;&nbsp;Octa-core (4x2.7 GHz Mongoose M3 & 4x1.7 GHz Cortex-A55)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Mali-G72 MP18 </p>
    ...
    <div class="card-deck">
        ...
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price : 665599 <br><br> Available in 2 variants<br> <em>Free-delivery</em>  </p>
