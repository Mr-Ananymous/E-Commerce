...
<meta charset="utf-8">
    ...
    <title>MobiZ-samsung galaxy note 9</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/samsung/samsung galaxy note 9.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/samsung/samsung galaxy note 9-1.jpg"  height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/samsung/samsung galaxy note 9-2.jpg" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","SAMSUNG GALAXY NOTE 9");
               at.setAttribute("price","34999");
               at.setAttribute("cmp","samsung");
               at.setAttribute("image","images/samsung/samsung galaxy note 9.jpg");
               at.setAttribute("link","note9.jsp");%>
        <h3>Samsung Galaxy NOTE 9 </h3>
        <p>by <a href="https://www.samsung.com/in/">SAMSUNG</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:34999 </p> 
        ...
        <p class="pane"> Internal Memory:  &nbsp;&nbsp; 128GB/512GB</p>
        <p class="pane"> Camera: &nbsp; 12MP+12MP+12MP Rear Camera+8MP Front camera</p>
        <p class="pane">CPU: &nbsp;&nbsp; Octa-core (4x2.7 GHz Mongoose M3 & 4x1.8 GHz Cortex-A55) - EMEA</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Mali-G72 MP18 - EMEA</p>
        <p class="pane">OS: &nbsp;&nbsp;Android 8.1 (Oreo), upgradable to Android 10; One UI 2.0</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>Android 10.0 operating system with 2.3GHz Exynos 9611-Octa Core processor</li>
