...
<meta charset="utf-8">
    ...
    <title>MobiZ-one plus 7 pro</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/oneplus/oneplus 7 pro.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/oneplus/oneplus 7 pro-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/oneplus/oneplus 7 pro-2.jpg"  height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Oneplus 7 pro ");
               at.setAttribute("price","34999");
               at.setAttribute("cmp","Oneplus");
               at.setAttribute("image","images/oneplus/oneplus 7 pro.jpg");
               at.setAttribute("link","oneplus 7 pro.jsp");%>
        <h3>Oneplus 7 Pro </h3>
        <p>by <a href="https://www.oneplus.in/">ONEPLUS</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:34999 </p> 
        ...
        <p class="pane"> Color: &nbsp;&nbsp;Metallic black  </p>
        <p class="pane"> RAM:  &nbsp;&nbsp;  8GB</p>
        <p class="pane"> Internal Memory:  &nbsp;&nbsp; 256GB</p>
        <p class="pane"> Camera: &nbsp;Rear Camera - 48MP (Primary) + 8MP (Tele-photo)+16MP (Ultrawide) | Front Camera - 16 MP POP-UP Camera</p>
        <p class="pane">CPU: &nbsp;&nbsp; Octa-core (1x2.84 GHz Kryo 485 & 3x2.42 GHz Kryo 485 & 4x1.78 GHz Kryo 485)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Adreno 640</p>
        <p class="pane">OS: &nbsp;&nbsp;Android 9.0 (Pie); OxygenOS 10.0.5</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>Rear Camera - 48MP (Primary) + 8MP (Tele-photo)+16MP (Ultrawide) | Front Camera - 16 MP POP-UP Camera</li>
