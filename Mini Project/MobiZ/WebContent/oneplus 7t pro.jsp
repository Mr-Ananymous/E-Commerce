...
<meta charset="utf-8">
    ...
    <title>MobiZ-one plus 7T pro</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/oneplus/oneplus 7T pro.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/oneplus/oneplus 7T pro-1.jpg"  height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/oneplus/oneplus 7T pro-2.jpg" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Oneplus 7T pro ");
               at.setAttribute("price","52999");
               at.setAttribute("cmp","Oneplus");
               at.setAttribute("image","images/oneplus/oneplus 7T pro.jpg");
               at.setAttribute("link","oneplus 7T pro.jsp");%>
        <h3>Oneplus 7T pro</h3>
        <p>by <a href="https://www.oneplus.in/">ONEPLUS</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:52999 </p> 
        ...
        <p class="pane">OS: &nbsp;&nbsp;Android 10; OxygenOS 10.0.4</p>
