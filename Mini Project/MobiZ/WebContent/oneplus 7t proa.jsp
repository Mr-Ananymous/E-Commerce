...
<meta charset="utf-8">
    ...
    <title>MobiZ-one plus 7T pro Mclaren Edition</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/oneplus/oneplus 7T proa.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/oneplus/oneplus 7T proa-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/oneplus/oneplus 7T proa-2.jpg"  height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Oneplus 7T pro Mclaren Edition ");
               at.setAttribute("price","58999");
               at.setAttribute("cmp","Oneplus");
               at.setAttribute("image","images/oneplus/oneplus 7t proa.jpg");
               at.setAttribute("link","oneplus 7T proa.jsp");%>
        <h3>Oneplus 7T pro Mclaren Edition </h3>
        <p>by <a href="https://www.oneplus.in/">ONEPLUS</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:58999 </p> 
        ...
        <p class="pane"> Color: &nbsp;&nbsp;Coal black with texture </p>
        <p class="pane"> RAM:  &nbsp;&nbsp;  8GB</p>
        <p class="pane"> Internal Memory:  &nbsp;&nbsp; 256GB</p>
        <p class="pane"> Camera: &nbsp;48+8+16MP triple rear camera with telephoto lens + ultrawide angle lens | 16MP front cameraa</p>
        <p class="pane">CPU: &nbsp;&nbsp;Octa-core (1x2.96 GHz Kryo 485 & 3x2.42 GHz Kryo 485 & 4x1.78 GHz Kryo 485)</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>16.94 centimeters (6.67 inch) 90Hz fluid display with 3120 x 1440 pixels resolution and 516 ppi pixel density</li>
        <li>Memory, Storage & SIM: 8GB RAM | 256GB internal memory | Dual SIM (nano+nano) dual-standby (4G+4G)</li>
    ...
    <div class="card-deck">
        ...
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price : 52,999 <br><br> Available in 3 variants <br> <em>Free-delivery</em> </p>
                <a href="oneplus 7t pro.jsp" class="btn btn-primary">Buy now </a>
            </div>
        </div>
        <div class="card bg-light">
            <img class="card-img-top" src="images/oneplus/oneplus 8 pro.jpg">
            <div class="card-body text-center">
                <h4 class="card-title"> oneplus 8 pro</h4>
                <p class="card-text"> Price : 54,999 <br><br> Available in 2 variants<br> <em>Free-delivery</em>  </p>
                <a href="oneplus 8 pro.jsp" class="btn btn-primary">Buy now </a>
            </div>
