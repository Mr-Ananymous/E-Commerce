...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/oneplus/oneplus 8.jpg" height="400px">
            </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Oneplus 8");
               at.setAttribute("price","41999");
               at.setAttribute("cmp","Oneplus");
               at.setAttribute("image","images/oneplus/oneplus 8.jpg");
               at.setAttribute("link","oneplus 8.jsp");%>
        <h3>Oneplus 8  </h3>
        ...
        <p class="pane"> Camera: &nbsp;Rear Camera - 48 MP + 16 MP + 2 MP| Front Camera - 16 MP</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>Rear Camera - 48MP + 8MP+16MP| Front Camera - 16 MP </li>
        <li>Non-removable Li-Po 4300 mAh battery</li>
        <li>Qualcomm SM8250 Snapdragon 865 (7 nm+)</li>
    ...
    <div class="card-deck">
        ...
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price : 58999 <br> Available in 2 variants <br> <em>Free-delivery</em> </p>
