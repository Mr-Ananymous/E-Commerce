...
<meta charset="utf-8">
    ...
    <title>MobiZ-Poco F1 Armoured Edition</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Poco f1 Armoured edition");
               at.setAttribute("price","16999");
               at.setAttribute("cmp","poco");
               at.setAttribute("image","images/poco/poco f1.jpg");
               at.setAttribute("link","poco f1-1.jsp");%>
                <h3>POCO F1-Armoured Edition</h3>
    ...
    <div class="card-deck">
        ...
        <img class="card-img-top" src="images/poco/poco f1.jpg">
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price :14899 <br> Available in 2 variants <br> <em>Free-delivery</em> </p>
