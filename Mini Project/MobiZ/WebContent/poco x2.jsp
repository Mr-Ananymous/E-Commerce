...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/poco/poco x2.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/poco/poco x2-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/poco/poco x2-2.webp" width="350px" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Poco x2");
               at.setAttribute("price","16999");
               at.setAttribute("cmp","poco");
               at.setAttribute("image","images/poco/poco x2.jpg");
               at.setAttribute("link","poco x2.jsp");%>
                <h3>POCO x2</h3>
        <p>by <a href="https://www.poco.in/in/"> POCO</a> </p> &nbsp;&nbsp;&nbsp;&nbsp; Price:16999 </p> 
    ...
    <div class="card-deck">
        ...
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <a href="poco f1.jsp" class="btn btn-primary">Buy now </a>
            </div>
