...
<meta charset="ISO-8859-1">
 ...
 <div class="container-fluid bg-info text-white product">
       <div id="ad"class="carousel slide car" data-ride="carousel">
        ...
        <img src="images/acc/pb2.jpg" width="300px" height="350px">
        </div>
        <div class="carousel-item">
        <img src="images/acc/pb3.jpg"width="300px" height="350px">
        </div>
        </div>
        </div>
        ...
        <span class="carousel-control-next-icon"></span>
               ...
               at.setAttribute("name","Power bank");
               at.setAttribute("price","2400");
               at.setAttribute("cmp","acc");
               at.setAttribute("image","images/acc/pb2.jpg");
               at.setAttribute("link","power bank.jsp");%>
        <div class="container bg-light text-dark spec">
          <h3>Sandisk memory card </h3>
           <p >by <a href="https://www.micromaxinfo.com/">Micromax</a>  &nbsp;&nbsp;&nbsp;&nbsp; Price:2400 </p> 
        ...
        <div class="container bg-light text-dark spec">
          ...
          <h3>Micromax 10400mah Power Bank</h3>
                 <hr><b><p style="font-size:15px;"> Specifications</p></b>
          <p class="pane"> Model: &nbsp;&nbsp; Power Bank 10400 Mah</p>
          <p class="pane"> Suitable device:  &nbsp;&nbsp; 	Mobile</p>
          <p class="pane"> No.of output ports:  &nbsp;&nbsp; 2</p>
          <p class="pane"> Warranty: &nbsp;&nbsp; 6 years </p>
         <p class="pane">Color: &nbsp;&nbsp; Black</p>
          <p class="pane">Charging cable included:  &nbsp;&nbsp;  yes</p>
          <p class="pane">Output power: &nbsp;&nbsp; 5V/2.1A</p>
