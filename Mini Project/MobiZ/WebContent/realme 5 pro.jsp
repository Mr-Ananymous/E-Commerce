...
<meta charset="utf-8">
    ...
    <title>MobiZ-Realme 5 pro</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/realme/realme 5 pro.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/realme/realme 5 pro-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/realme/realme 5 pro-2.jpg" width="350px" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Realme 5 pro");
               at.setAttribute("price","13999");
               at.setAttribute("cmp","realme");
               at.setAttribute("image","images/realme/realme 5 pro.jpg");
               at.setAttribute("link","realme 5 pro.jsp");%>
        <h3>Realme 5 pro </h3>
        <p>by <a href="https://www.realme.com/in/">REALME</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:13999 </p> 
        ...
        <p class="pane"> Color: &nbsp;&nbsp;Sparkling Blue </p>
        <p class="pane"> RAM:  &nbsp;&nbsp;  4GB</p>
        <p class="pane"> Internal Memory:  &nbsp;&nbsp; 64GB</p>
        <p class="pane"> Camera: &nbsp; 48MP + 8MP + 2MP +2MP | 16MP </p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    <h4>Cheap and Compact</h4>
    <ul>

        <li>screen offers 90.6% screen-to-body ratio and 2340x1080p resolution.   </li>
     <li>48MP camera comes powered by Sony IMX586 sensor which clicks high resolution images without compromising the pixels at all. The 2MP macro lens, on the other hand comes with f/2.4 aperture and helps deliver more focused bokeh effect</li>
        <li>4305 mAh Battery </li>
        <li> powered by Qualcomm Snapdragon 712 AIE octa-core processor clocked at 2.3GHz. The device houses a 4035mAh battery with VOOC Flash charge 3.0 support. </li>
    ...
    <div class="card-deck">
        ...
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price :13999 <br><br> Available in 3 variants <br> <br> </p>
