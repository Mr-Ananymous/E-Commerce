...
<meta charset="utf-8">
    ...
    <title>MobiZ-Realme 6 pro</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/realme/realme 6 pro.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/realme/realme 6 pro-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/realme/realme 6 pro-2.webp" width="350px" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Realme 6 pro");
               at.setAttribute("price","17999");
               at.setAttribute("cmp","realme");
               at.setAttribute("image","images/realme/realme 6 pro.jpg");
               at.setAttribute("link","realme 6 pro.jsp");%>
        <h3>Realme 6 PRO </h3>
        <p>by <a href="https://www.realme.com/in/">REALME</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:17999 </p> 
        ...
        <p class="pane"> Color: &nbsp;&nbsp;Lightning blue</p>
        <p class="pane"> RAM:  &nbsp;&nbsp;  6GB</p>
        <p class="pane"> Internal Memory:  &nbsp;&nbsp; 64GB</p>
        <p class="pane"> Camera: &nbsp; 64MP + 8MP + 12MP +2MP | 16MP+ 8 MP </p>
        <p class="pane">CPU: &nbsp;&nbsp;>Qualcomm Snapdragon 720GT</p>
        <p class="pane">OS: &nbsp;&nbsp;Android 9</p>
        <p class="pane">Fingerprint: &nbsp;&nbsp; Yes</p>
    </div>
</div>
<br><br>
<hr>
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    <h4>Cheap but Extraodinary Features</h4>
    <ul>

        <li>powered by Octa core (2.3 GHz, Dual core, Kryo 465 + 1.8 GHz, Hexa Core, Kryo 465) processor. It runs on the Qualcomm Snapdragon 720G Chipset </li>
        <li>has a IPS LCD display. It measures 163.8 mm x 75.8 mm x 8.9 mm and weighs 202 grams. The screen has a resolution of 1080 x 2400 pixels and 399 ppi pixel density.</li>
        <li>4300 mAh Battery </li>
        <li> 64+8+2+2 MP camera with features like 10 x Digital Zoom, Auto Flash, Face detection, Touch to focus</li>
