...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/realme/realme 6.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/realme/realme 6-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/realme/realme 6-2.webp" width="350px" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Realme 6");
               at.setAttribute("price","13999");
               at.setAttribute("cmp","realme");
               at.setAttribute("image","images/realme/realme 6.jpg");
               at.setAttribute("link","realme 6.jsp");%>
        <h3>Realme 6  </h3>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>powered by Octa core (2.05 GHz, Dual core, Cortex A76 + 2 GHz, Hexa Core, Cortex A55) processor. It runs on the MediaTek Helio G90T Chipset.  </li>
        <li>The screen has a resolution of 1080 x 2400 pixels and 405 ppi pixel density.</li>
