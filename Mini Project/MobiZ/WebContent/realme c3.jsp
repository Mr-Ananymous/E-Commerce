...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/realme/realme c3.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/realme/realme c3-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/realme/realme c3-2.webp" width="350px" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Realme c3");
               at.setAttribute("price","7999");
               at.setAttribute("cmp","realme");
               at.setAttribute("image","images/realme/realme c3.jpg");
               at.setAttribute("link","realme c3.jsp");%>
        <h3>Real me C3 </h3>
        <p>by <a href="https://www.realme.com/in/">REALME</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:7999 </p> 
        ...
        <p class="pane"> Color: &nbsp;&nbsp;Red </p>
        <p class="pane"> RAM:  &nbsp;&nbsp;  3GB</p>
        <p class="pane"> Internal Memory:  &nbsp;&nbsp; 64GB</p>
        <p class="pane"> Camera: &nbsp; 12MP + 2MP | 5MP Front Camera</p>
        <p class="pane">CPU: &nbsp;&nbsp;>Helio G70 Processor</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
       ...
       <li> Expandable Upto 256 GB </li>li>
    ...
    <div class="card-deck">
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price : 13999<br> Available in 3 variants </p>
