...
<meta charset="utf-8">
    ...
    <title>MobiZ-redmi k20 pro</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/redmi/redmi k20 pro.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/redmi/redmi k20 pro-1.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/redmi/redmi k20 pro-2.jpg" width="400px" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Redmi k20 pro");
               at.setAttribute("price","23999");
               at.setAttribute("cmp","Redmi");
               at.setAttribute("image","images/redmi/redmi k20 pro.jpg");
               at.setAttribute("link","redmi k20 pro.jsp");%>
        <h3>REDMI K20 PRO </h3>
        <p>by <a href="https://mobile.mi.com/in/">REDMI</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:23999 </p> 
        ...
        <p class="pane"> Camera: &nbsp;48+13+8MP primary camera with 20MP front facing camera</p>
        <p class="pane">CPU: &nbsp;&nbsp;Octa-core (1x2.84 GHz Kryo 485 & 3x2.42 GHz Kryo 485 & 4x1.78 GHz Kryo 485)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Adreno 640</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>Android v9 Pie operating system (Upgradable to Android Q) with 2.84GHz Qualcomm Snapdragon 855 Octa core processor, Adreno 640 GPU</li>
        <li>4000mAH lithium-ion battery</li>
        <li>16.23 centimeters (6.39-inch) AMOLED capacitive touchscreen with 2340 x 1080 pixels resolution, 403 ppi pixel density</li>
    ...
    <div class="card-deck">
        ...
        <div class="card bg-light">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text"> Price : 12500 <br><br> Available in 3 variants <br> <em>Free-delivery</em> </p>
                <a href="redmi note 7 pro.jsp" class="btn btn-primary">Buy now </a>
            </div>
        </div>
        <div class="card bg-light">
            <img class="card-img-top" src="images/redmi/redmi note 6 pro pro.jpg">
            <div class="card-body text-center">
                <h4 class="card-title"> Redmi note 6 pro</h4>
                <p class="card-text"> Price : 11999 <br><br> Available in 2 variants<br> <em>Free-delivery</em>  </p>
                <a href="redmi note 6 pro.jsp" class="btn btn-primary">Buy now </a>
            </div>
        </div><div class="card bg-light">
            <img class="card-img-top" src="images/redmi/redmi note 8.jpg">
            <div class="card-body text-center">
                <h4 class="card-title"> Redmi note 8</h4>
                <p class="card-text"> Price : 9999 <br> Available in 2 variants <br> <em>Free-delivery</em> </p>
                <a href="redmi note 8.jsp" class="btn btn-primary">Buy now </a>
            </div>
        </div>
    </div>
</div>
