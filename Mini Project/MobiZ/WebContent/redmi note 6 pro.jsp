...
<meta charset="utf-8">
    ...
    <title>MobiZ-redmi note 6 pro</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/redmi/redmi note 6 pro.jpg" height="400px" >
            </div>
            <div class="carousel-item">
                <img src="images/redmi/redmi note 6 pro-1.jpg"  height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/redmi/redmi note 6 pro-2.jpg" width="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Redmi note 6 pro");
               at.setAttribute("price","11999");
               at.setAttribute("cmp","Redmi");
               at.setAttribute("image","images/redmi/redmi note 6 pro.jpg");
               at.setAttribute("link","redmi note 6 pro.jsp");%>
        <h3>REDMI NOTE 6 PRO </h3>
        <p>by <a href="https://mobile.mi.com/in/">REDMI</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:11999 </p> 
        ...
        <p class="pane"> Camera: &nbsp;12MP+5MP dual rear camera | 20MP+2MP dual front camera</p>
        <p class="pane">CPU: &nbsp;&nbsp;Octa-core (4x1.8 GHz Kryo 260 Gold & 4x1.6 GHz Kryo 260 Silver)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Adreno 509</p>
        <p class="pane">OS: &nbsp;&nbsp;Android 8.1 (Oreo), upgradable to Android 9.0 (Pie); MIUI 11</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>Android Oreo v8.1 operating system with 1.8GHz Qualcomm Snapdragon 636 processor, Adreno 509</li>
        <li>4000mAH lithium-ion battery</li>
        <li>15.9004 centimeters (6.26-inch) multi-touch capacitive touchscreen with 2280 x 1080 pixels resolution</li>
