...
<meta charset="utf-8">
    ...
    <title>MobiZ-redmi note 7 pro</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/redmi/redmi note 7 pro.jpg" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/redmi/redmi note 7 pro-1.jpg" width="370px" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/redmi/redmi note 7 pro-2.jpg"  height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Redmi note 7 pro");
               at.setAttribute("price","12500");
               at.setAttribute("cmp","Redmi");
               at.setAttribute("image","images/redmi/redmi note 7 pro.jpg");
               at.setAttribute("link","redmi note 7 pro.jsp");%>
        <h3>REDMI NOTE 7 PRO </h3>
        <p>by <a href="https://mobile.mi.com/in/">REDMI</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:12500 </p> 
        ...
        <p class="pane"> Camera: &nbsp;13 MP Front Camera</p>
        <p class="pane">CPU: &nbsp;&nbsp;Octa-core (2x2.0 GHz Kryo 460 Gold & 6x1.7 GHz Kryo 460 Silver)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Adreno 612</p>
