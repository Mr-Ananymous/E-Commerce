...
<meta charset="utf-8">
    ...
    <title>MobiZ-REDMI NOTE 8 PRO</title>
</head>
<body>
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/redmi/redmi-1.png" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/redmi/redmi-2.png" width="370px" height="400px">
            </div>
            <div class="carousel-item">
                <img src="images/redmi/redmi-3.png" width="400px" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
         <% ServletContext at=getServletContext();
               at.setAttribute("name","Redmi note 8 pro");
               at.setAttribute("price","16999");
               at.setAttribute("cmp","Redmi");
               at.setAttribute("image","images/redmi/redmi-1.png");
               at.setAttribute("link","redmi note 8 pro.jsp");%>
        <h3>REDMI NOTE 8 PRO </h3>
        <p>by <a href="https://mobile.mi.com/in/">REDMI</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:16999 </p> 
        ...
        <p class="pane"> Camera: &nbsp;64 MP + 8 MP + 2 MP + 2 MP Rear camera, 20 MP Front Camera</p>
        <p class="pane">CPU: &nbsp;&nbsp; Octa-core (2x2.05 GHz Cortex-A76 & 6x2.0 GHz Cortex-A55)</p>
        <p class="pane">GPU:  &nbsp;&nbsp;vMali-G76 MC4</p>
        <p class="pane">OS: &nbsp;&nbsp;Android 9.0 (Pie), upgradable to Android 10; MIUI 11</p>
        <p class="pane">Fingerprint: &nbsp;&nbsp; vrear-mounted</p>
    </div>
</div>
<br><br>
<hr>
