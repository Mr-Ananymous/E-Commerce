...
<head>
    ...
    <title>MobiZ-ASUS ROG PHONE 2</title>
</head>
<body>
    <div class="container-fluid bg-dark text-white">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark shadow p-4 mb-4">
            ...
            <a class="brand" href="Login.html">
                <img src="shopping-cart.jpg" width="50px">&nbsp;
            </a>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="container-fluid bg-info text-white product">
    ...
    <div id="ad" class="carousel slide car" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/home/nithishguhan/Documents/Mobikart/Asus rog/asus rog.jpg" height="400px" width="450px">
            </div>
            <div class="carousel-item">
                <img src="/home/nithishguhan/Documents/Mobikart/Asus rog/asus rog front.jpg" width="370px" height="400px">
            </div>
            <div class="carousel-item">
                <img src="/home/nithishguhan/Documents/Mobikart/Asus rog/asus rog back1.jpeg" width="400px" height="400px">
            </div>
        </div>
    ...
    <div class="container bg-light text-dark spec">
        ...
        <p>by <a href="https://www.asus.com/in/">ASUS</a> </p>
        ...
        <p class="pane"> Camera: &nbsp;48 + 13 MP Dual Rear Cameras, 24 MP Front Camera</p>
        <p class="pane">CPU: &nbsp;&nbsp; Qualcomm Snapdragon 855 Plus Octa core Processor</p>
        <p class="pane">GPU:  &nbsp;&nbsp;Adreno 640 (700 MHz)</p>
        <p class="pane">OS: &nbsp;&nbsp; Android v9.0 (Pie) Upgradable to v10 (Q)</p>
        <p class="pane">Fingerprint: &nbsp;&nbsp; on screen</p>
    </div>
</div>
<br>
<hr>
<div class="container bg-light" style="border-radius:5px;padding:13px;">
    ...
    <ul>
        ...
        <li>Fastest1 Qualcomm Snapdragon 855 Plus, 8GB RAM</li>
        <li>Battery - 6000mAh</li>
        <li>The ultrafast 120Hz/1ms AMOLED 10-bit HDR screen has world-beating Delta-E < 1 color accuracy</li>
...
<div class="container">
    ...
    <div class="card-deck">
        <div class="card bg-light">
            <img class="card-img-top" src="card5.png">
        ...
        <div class="card bg-light">
            <img class="card-img-top" src="card6.jpeg">
            <div class="card-body text-center">
        ...
        <div class="card bg-light">
            <img class="card-img-top" src="card7.png">
            <div class="card-body text-center">
            ...
            <img class="card-img-top" src="card8.jpg">
            <div class="card-body text-center">
...
<div class="jumbotron bg-dark text-center text-white">
    ...
    <h1>   <img src="covid.png" height="150px" width="350px">&nbsp;&nbsp;&nbsp;&nbsp;Stay Home Stay Safe </h1>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
...
<div class="container">
    <div class="card-deck">
        <div class="card bg-light">
            <img class="card-img-top" src="card9.jpg">
            <div class="card-body text-center">
        ...
        <div class="card bg-light">
            <img class="card-img-top" src="card10.jpg">
            <div class="card-body text-center">
        ...
        <div class="card bg-light">
            <img class="card-img-top" src="card11.jpg">
            <div class="card-body text-center">
            ...
            <img class="card-img-top" src="card12.jpeg">
            <div class="card-body text-center">
...
<footer class="text-white bg-dark">
    ...
    <h6 class="text-center">
        Open source project powered by &nbsp;&nbsp;<img src="html-5.png">&nbsp;&nbsp;<img src="css.png">
        &nbsp;&nbsp;<img src="java.png">&nbsp;&nbsp;<img src="bootstrap.png">
    </h6><br>
    <h5 class="text-center">Contact info </h5>
    <h6 class="text-center">&nbsp;&nbsp;<img src="mail.png">&nbsp;iamnithishguhan@gmail.com </h6>
