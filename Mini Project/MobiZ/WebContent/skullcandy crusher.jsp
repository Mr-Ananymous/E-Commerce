...
<meta charset="ISO-8859-1">
 ...
 <div class="container-fluid bg-info text-white product">
       <div id="ad"class="carousel slide car" data-ride="carousel">
        ...
        <img src="images/acc/skull.jpg" width="300px" height="350px">
        </div>
        <div class="carousel-item">
        <img src="images/acc/skull1.jpg"width="300px" height="350px">
        </div>
        <div class="carousel-item">
        <img src="images/acc/skull2.jpg"width="300px" height="300px">
        </div>
        </div>
        ...
        <span class="carousel-control-next-icon"></span>
               ...
               at.setAttribute("name","Skullcandy crusher");
               at.setAttribute("price","12999");
               at.setAttribute("cmp","acc");
               at.setAttribute("image","images/acc/skull.jpg");
               at.setAttribute("link","skullcandy crusher.jsp");%>
        <div class="container bg-light text-dark spec">
          <h3>Skull Candy Crusher </h3>
          <p >by <a href="https://www.skullcandy.eu/">Skull Candy</a>  &nbsp;&nbsp;&nbsp;&nbsp; Price:12999 </p> 
        ...
        <% String i=(String)request.getAttribute("flag"); 
          ...
          <p class="pane"> Model: &nbsp;&nbsp;  S6CRW-K591 Crusher</p>
          <p class="pane"> Headphone type:  &nbsp;&nbsp;  Wireless over the head</p>
          <p class="pane"> Inline remote:  &nbsp;&nbsp; yes</p>
          <p class="pane"> Warranty: &nbsp;&nbsp; 2 years </p>
         <p class="pane">Color: &nbsp;&nbsp; Black</p>
          <p class="pane">Connectivity:  &nbsp;&nbsp;  Bluetooth</p>
          <p class="pane">Weight: &nbsp;&nbsp; 9.8 ounces</p>
