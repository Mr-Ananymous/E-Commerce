...
<meta charset="ISO-8859-1">
 ...
 <div class="container-fluid bg-info text-white product">
       <div id="ad"class="carousel slide car" data-ride="carousel">
        ...
        <img src="images/indey.jpg" width="300px" height="350px">
        </div>
        <div class="carousel-item">
        <img src="images/indey1.jpg"width="300px" height="350px">
        </div>
        <div class="carousel-item">
        <img src="images/indey2.jpg"width="300px" height="300px">
        </div>
        </div>
        ...
        <span class="carousel-control-next-icon"></span>
               ...
               at.setAttribute("name","Skullcandy indey");
               at.setAttribute("price","7499");
               at.setAttribute("cmp","acc");
               at.setAttribute("image","images/acc/indey.jpg");
               at.setAttribute("link","skullcandy indey.jsp");%>
        <div class="container bg-light text-dark spec">
          <h3>Skull Candy Indey</h3>
          <p >by <a href="https://www.skullcandy.eu/">Skull Candy</a> &nbsp;&nbsp;&nbsp;&nbsp; Price:7499 </p> 
        ...
        <% String i=(String)request.getAttribute("flag"); 
          ...
          <p class="pane"> Model: &nbsp;&nbsp;  S2SSW-M003</p>
          <p class="pane"> Headphone type:  &nbsp;&nbsp; 	In Ear</p>
          <p class="pane"> Batteries Included:  &nbsp;&nbsp; yes</p>
          <p class="pane"> Warranty: &nbsp;&nbsp; 2 years </p>
         <p class="pane">Color: &nbsp;&nbsp; Black</p>
          <p class="pane">Connectivity:  &nbsp;&nbsp;  Bluetooth</p>
          <p class="pane">Weight: &nbsp;&nbsp; 0.32 ounces</p>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
  ...
  <ul>
    <li>1 Lithium Metal batteries required. (included)</li>
    <li>Adjustable sensory bass</li>
    <li>Noise isolating fit</li>
  <li>Headphone, Charging Case, User Manual</li>
...
<div class="container bg-light" style="border-radius:5px;padding:13px;">
  <h4>Perfect choice for smart-buyers </h4>
  <ul>
    <li>Rapid Charge: 10 mins = 3 Hours;40 hours of total life battery</li>
    <li>Adjustable sensory bass</li>
    <li>Noise isolating fit</li>
